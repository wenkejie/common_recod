...
;(function($) {
	$.fn.spinner = function(opts) {
		return this.each(function() {
				...
				// 加+
				var increaseButton = $('<button type="button" class="increase">+</button>')
						.click(function() {
							if ($(this).hasClass("spinner-disabled")) return;
							changeValue(1);
						});
				// 减-
				var decreaseButton = $('<button type="button" class="decrease"><i></i></button>')
						.click(function() {
							if ($(this).hasClass("spinner-disabled")) return;
							changeValue(-1);
						});
