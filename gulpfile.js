...
gulp.task('less', function () {
  ...
  gulp.src([devPath+'/src/less/fcommon.v1.2.less',devPath+'/src/less/new-serviceportal/style.less'])
  .pipe(plumber())
  .pipe(sourcemaps.init())
  .pipe(less())
  .pipe(autoprefixer({browsers: AUTOPREFIXER_BROWSERS}))
  // .pipe(sourcemaps.write('./maps'))
  .pipe(gulp.dest([devPath+'/release/freight/css/common-v1.2.css',devPath+'/release/freight/css/new-serviceportal/style.css']))
  .pipe(connect.reload());
});
